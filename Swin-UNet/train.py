...
parser.add_argument('--root_path', type=str,
                    default='./layer_seg/transunet_human_data/cortex/train_npz', help='root dir for data')
...
parser.add_argument('--max_epochs', type=int,
                    default=51, help='maximum epoch number to train')
...
if __name__ == "__main__":
    ...
    dataset_config = {
        'cortex': {
            'root_path': './layer_seg/transunet_human_data/cortex/train_npz',
            'list_dir': './layer_seg/transunet_human_data/cortex/lists',
            'num_classes': 2,
        },
    }
    ...
    net = net.cuda()
    snapshot_path = './layer_seg/swin-unet/model_out/cortex2'

    trainer = {'cortex': trainer_synapse,}
