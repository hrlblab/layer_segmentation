...
def iou(pred, target, n_classes=7, softmax=True):
    if softmax:
...
def trainer_synapse(args, model, snapshot_path):
    ...
    with open(os.path.join(VOCdevkit_path, "ImageSets/Segmentation/test_mouse.txt"), "r") as f:
    ...
    log_dir = './layer_seg/transunet/model/combined'
